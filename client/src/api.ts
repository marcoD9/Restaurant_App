...
export const fetchDishById = async (id: string): Promise<Dish> => {
  ...
  try {
    const response = await fetch(
      `https://restaurant-app-2oum.onrender.com/dishes/${id}`
    );
    if (!response.ok) {
      throw new Error(`HTTP error! status: ${response.status}`);
    }
...
export const fetchUserById = async (
  ...
  try {
    const response = await fetch(
      `https://restaurant-app-2oum.onrender.com/users/${id}`,
      {
        headers: {
...
export const login = async (
  ...
  try {
    const response = await fetch(
      `https://restaurant-app-2oum.onrender.com/login`,
      {
        method: "POST",
        headers: {
...
export const createAccount = async (
  ...
  try {
    const response = await fetch(
      "https://restaurant-app-2oum.onrender.com/users",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const createOrder = async (
  ...
  try {
    const response = await fetch(
      "https://restaurant-app-2oum.onrender.com/orders",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const fetchOrdersByUserId = async (
  ...
  try {
    const response = await fetch(
      `https://restaurant-app-2oum.onrender.com/orders/user/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
